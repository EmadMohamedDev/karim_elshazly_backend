				...
				<div class="box-content">
					...
					<div class="table-responsive">
						<table id="example" class="table table-striped dt-responsive" cellspacing="0" width="100%">
							<thead>
							<tr>
                                <th style="width:18px"><input type="checkbox" onchange="select_all('countries',false)"></th>
                          ...
                          @if($countries !=null)
							@foreach($countries as $country)
								<tr class="table-flag-blue">
                                    <th><input type="checkbox" name="selected_rows[]" value="{{$country->id}}" class="select-all-karim" onclick="collect_selected(this)"></th>
                                    <td>{{$country->title}}</td>
