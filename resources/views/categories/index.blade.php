				...
				<div class="box-content">
					...
					<div class="table-responsive">
						<table id="example" class="table table-striped dt-responsive" cellspacing="0" width="100%">
							<thead>
							<tr>
                                <th style="width:18px"><input type="checkbox" onclick="select_all('categories',false)"></th>
                          ...
                          @if($categories !=null)
							@foreach($categories as $category)
								<tr class="table-flag-blue">
                                    <th><input type="checkbox" class="select-all-karim" name="selected_rows[]" value="{{$category->id}}" onclick="collect_selected(this)"></th>
